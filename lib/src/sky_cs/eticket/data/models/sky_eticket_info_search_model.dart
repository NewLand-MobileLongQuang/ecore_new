...
class SKY_ETicketInfo_Model extends SKY_TicketInfo {
  SKY_ETicketInfo_Model(
      {
  ...
  factory SKY_ETicketInfo_Model.fromJson(Map<String, dynamic> json) {
    return SKY_ETicketInfo_Model(
