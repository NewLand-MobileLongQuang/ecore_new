import '../../domain/entities/sky_eticket_get_messagepin.dart';


class SKY_TicketMessagePinModel extends SKY_TicketMessagePin {
  ...
  factory SKY_TicketMessagePinModel.fromJson(Map<String, dynamic> json) {
    return SKY_TicketMessagePinModel(
  ...
  // Helper method to safely convert dynamic value to List
