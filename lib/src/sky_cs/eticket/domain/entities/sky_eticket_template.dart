...
class SKY_ETicket_MetaScreenTemplate extends Equatable {
  SKY_ETicket_MetaScreenTemplate(
      {required this.OrgID,
  ...
  @override
  List<Object?> get props => [OrgID, ETScrTplCodeSys, NetworkID, ScrTplCode, ScrTplName, FlagDefault, FlagActive, CreateDTimeUTC, CreateBy, LogLUDTimeUTC, LogLUBy];
}