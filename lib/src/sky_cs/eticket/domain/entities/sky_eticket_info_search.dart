...
class SKY_ETicketInfo extends Equatable {
  SKY_ETicketInfo({
    ...
    required this.TicketEvaluate,
    required this.RemindDTimeUTC,
    ...
    required this.LUBy,
    required this.ProcessDTimeUTC,
    required this.ProcessBy,
    required this.CloseDTimeUTC,
    ...
    required this.AgentContactChannelName,
    required this.CustomerContactChannelName,
    required this.SLALevel,
    required this.NNTFullName,
    required this.ProcessTime,
    required this.TicketWarning,
    required this.DTimeSys,
    required this.FirstResTime,
    required this.FistTicketMessage,
    required this.ResolutionTime,
    required this.CustomerPhoneNo,
    required this.CustomerEmail,
    required this.ZaloUserFollowerId,
    required this.ListFollowerAgentCode,
    required this.ListFollowerAgentName,
    required this.QtyMissCall,
    required this.ScrTplCreateCodeSys,
    required this.ScrTplDetailCodeSys,
    required this.CustomerDateOfBirth,
    required this.PhoneNoUseService,
    required this.IdentityPaper,
    required this.IdentityPaperDate,
    required this.AccountNumber,
    required this.TicketPhoneNo,
    required this.OrgIDCreate,
    required this.DepartmentCodeCreate,
    required this.AgentCodePrevious,
    required this.DepartmentCodePrevious,
    required this.OrgIDPrevious,
    required this.AgentNameCreate,
    required this.DepartmentNameCreate,
    required this.NNTFullNameCreate,
    required this.AgentNamePrevious,
    required this.DepartmentNamePrevious,
    required this.NNTFullNamePrevious,
  });
  ...
  final String TicketEvaluate;
  final String RemindDTimeUTC;
  ...
  final String LUBy;
  final String ProcessDTimeUTC;
  final String ProcessBy;
  final String CloseDTimeUTC;
  ...
  final String AgentContactChannelName;
  final String CustomerContactChannelName;
  final String SLALevel;
  final String NNTFullName;
  final String ProcessTime;
  final String TicketWarning;
  final String DTimeSys;
  final double FirstResTime;
  final String FistTicketMessage;
  final double ResolutionTime;
  final String CustomerPhoneNo;
  final String CustomerEmail;
  final String ZaloUserFollowerId;
  final String ListFollowerAgentCode;
  final String ListFollowerAgentName;
  final String QtyMissCall;
  final String ScrTplCreateCodeSys;
  final String ScrTplDetailCodeSys;
  final String CustomerDateOfBirth;
  final String PhoneNoUseService;
  final String IdentityPaper;
  final String IdentityPaperDate;
  final String AccountNumber;
  final String TicketPhoneNo;
  final String OrgIDCreate;
  final String DepartmentCodeCreate;
  final String AgentCodePrevious;
  final String DepartmentCodePrevious;
  final String OrgIDPrevious;
  final String AgentNameCreate;
  final String DepartmentNameCreate;
  final String NNTFullNameCreate;
  final String AgentNamePrevious;
  final String DepartmentNamePrevious;
  final String NNTFullNamePrevious;
