...
class ES_RODetail extends Equatable {
  ES_RODetail({required this.RONo, required this.OrgID, required this.NetworkID, required this.CustomerCodeSys, required this.CustomerName, required this.CustomerPhoneNo, required this.CustomerAddress, required this.CustomerAvatarPath, required this.ReceptionDTimeUTC, required this.AgentCode, required this.RODesc, required this.Deadline, required this.ROStatus, required this.ProductCode, required this.ProductName, required this.ProductCodeUser, required this.SerialNo, required this.FactoryCode, required this.ErrorTypeCode, required this.ErrorTypeName, required this.AppointmentDTimeUTC, required this.CreateDTimeUTC, required this.CreateBy, required this.Remark, required this.FinishDTimeUser, required this.FinishDTimeUTC, required this.FinishBy, required this.LUDTimeUTC, required this.LUBy, required this.LogLUDTimeUTC, required this.LogLUBy, required this.AgentName, required this.AgentAvatar, required this.ListComponentCode, required this.CustomerNameReal});
