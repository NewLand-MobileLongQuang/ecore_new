...
import '../../../src/e_service/index/presentation/views/e_service_screen.dart';
import '../router.dart';
...
PageRouteBuilder? handleCaseEService(RouteSettings settings) {
  ...
  switch(path){
    case EServiceScreen.routeName:
      return pageBuilder(
              (p0) => BlocProvider(
              create: (_) => sl<EServiceCubit>(),
              child: const EServiceScreen()),
          settings: settings);

    case GuaranteeManageScreen.routeName:
      return pageBuilder(
              (p0) => BlocProvider(
              create: (_) => sl<GuaranteeManageCubit>(),
              child: const GuaranteeManageScreen()),
          settings: settings);
    ...
    case GuaranteeDetailScreen.routeName:
      ...
      return pageBuilder(
              (p0) => BlocProvider(
              create: (_) => sl<GuaranteeDetailCubit>(),
              child: GuaranteeDetailScreen(id: id,)),
          settings: settings);
    ...
    case GuaranteeEditScreen.routeName:
      ...
      return pageBuilder(
              (p0) => BlocProvider(
              create: (_) => sl<GuaranteeEditCubit>(),
              child: GuaranteeEditScreen(id: id)),
          settings: settings);

    case GuaranteeActivateScreen.routeName:
      return pageBuilder(
              (p0) => BlocProvider(
              create: (_) => sl<GuaranteeActivateCubit>(),
              child: const GuaranteeActivateScreen()),
          settings: settings);

    case CustomerManageScreen.routeName:
      return pageBuilder(
              (p0) => BlocProvider(
              create: (_) => sl<CustomerManageCubit>(),
              child: const CustomerManageScreen()),
          settings: settings);

    case CustomerCreateScreen.routeName:
      return pageBuilder(
              (p0) => BlocProvider(
              create: (_) => sl<CustomerCreateCubit>(),
    ...
    case CustomerDetailScreen.routeName:
      ...
      return pageBuilder(
              (p0) => BlocProvider(
              create: (_) => sl<CustomerDetailCubit>(),
              child: CustomerDetailScreen(customerCodeSys: customerCodeSys,)),
          settings: settings);

    case RepairManageScreen.routeName:
      return pageBuilder(
              (p0) => const RepairManageScreen(),
          settings: settings);
    ...
    case RepairDetailScreen.routeName:
      ...
      return pageBuilder(
              (p0) => BlocProvider(
              create: (_) => sl<RepairDetailCubit>(),
              child: RepairDetailScreen(id: id,)),
          settings: settings);
    ...
    case RepairEditScreen.routeName:
      ...
      return pageBuilder(
              (p0) => BlocProvider(
              create: (_) => sl<RepairEditCubit>(),
              child: RepairEditScreen(id: id)),
          settings: settings);

    case RepairHistorySearchScreen.routeName:
      return pageBuilder(
              (p0) => BlocProvider(
              create: (_) => sl<RepairHistorySearchCubit>(),
              child: const RepairHistorySearchScreen()),
          settings: settings);
